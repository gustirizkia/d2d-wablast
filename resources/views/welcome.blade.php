...
<html lang="en">
  <head>
    ...
    <title>Relawan Prayudha Septiadi Nugraha</title>
    <!-- Favicon-->
        ...
        <div class="container px-5">
          <a class="navbar-brand" href="index.html"
            ><span class="fw-bolder text-primary"
              >Relawan Prayudha Septiadi Nugraha</span
            ></a
          >
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://d2d.binamuda.com">Login</a>
              </li>
              <li class="nav-item">
              ...
              <div class="text-center text-xxl-start">
                ...
                >
                  <div class="text-uppercase">
                    Calon &middot; Legislatif &middot; DAPIL III Banten
                  </div>
                </div>
                ...
                <h1 class="display-3 fw-bolder mb-5">
                  <span class="text-gradient d-inline"
                    >Prayudha Septiadi Nugraha</span
                  >
                </h1>
                <div
            ...
            <div class="col-xxl-7">
              ...
              <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                <div class="profile bg-gradient-primary-to-secondary">
                  ...
                  <img class="profile-img" src="{{ asset('/img/profile.png') }}" alt="..." />
                  <div class="dots-1">
                    <!-- SVG Dots-->
                    <svg
                      version="1.1"
    ...
    <footer class="bg-white py-4 mt-auto">
      <div class="container px-5">
        ...
        >
          <div class="col-auto">
            <div class="small m-0">
              Copyright &copy; Relawan Prayudha Septiadi Nugraha
            </div>
          </div>
          <!-- <div class="col-auto">
