    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-6">
                    <a href="{{route('admin.administator.create')}}" class="btn btn-warning">Tambah Data</a>
                </div>
                    ...
                    <tbody>
                        @forelse ($data['user'] as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{route('admin.administator.edit', $item->id)}}" class="btn btn-warning ">
                                            <i class="bi bi-pen"></i>
                                            <span class="ms-1">Edit</span>
                                        </a>

                                        <form action="{{ route('admin.administator.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method("DELETE")
